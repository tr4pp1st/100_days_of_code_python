# --- Local hardcoded quiz questions (for quick testing / offline use) ---
QUESTION_DATA = [
...
# Note: These questions are HTML-encoded; use `html.unescape()` when displaying
# They can also be fetched dynamically via requests instead of hardcoding (topic later in the course)
QUESTION_DATA_FROM_OPEN_TRIVIA_DB = [
